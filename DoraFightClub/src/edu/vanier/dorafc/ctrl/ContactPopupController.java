...
import edu.vanier.dorafc.model.CountryContactModel;
import edu.vanier.dorafc.util.network.RESTAPIController;
import edu.vanier.dorafc.util.parser.CountryContactParser;
import edu.vanier.dorafc.util.parser.GeoCodingParser;
import java.net.URL;
...
public class ContactPopupController implements Initializable {
    ...
    private ObservableList<CountryContactModel> list = FXCollections.observableArrayList(new ArrayList<CountryContactModel>());
